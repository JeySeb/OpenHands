...
class TestTaskConvAgent:
    ...
    def test_agent_initialization(self, taskconv_agent):
        ...
        assert (
            'TaskConvAgent extends CodeActAgent with specialized capabilities'
            in taskconv_agent.DESCRIPTION
        )
    ...
    def test_agent_capabilities(self, taskconv_agent):
        ...
        assert (
            ...
            in capabilities['taskconv_specializations']
        )
    ...
    def test_response_to_actions_delegation(
        self, mock_response_to_actions, taskconv_agent
    ):
        ...
        mock_response_to_actions.assert_called_once_with(
            mock_response, mcp_tool_names=list(taskconv_agent.mcp_tools.keys())
        )
        assert result == []
